...
const Navbar = () => {
    ...
    return (
        <div className="relative flex flex-row justify-between items-center max-w-[1215px] xl:mx-auto mt-5 mx-1 sm:mx-2 md:mx-6 lg:mx-8 px-1 sm:px-2 md:px-6 lg:px-8 h-15 bg-[#16161a] rounded-md">
            <div>
                {/*<img src={} alt="logo"/>*/}
            ...
            <div className="flex flex-row justify-between gap-3 sm:gap-8">
                ...
                <div className="bg-[#94a1b2] w-[1px] hidden sm:flex"></div>
                {userInfo == null
                    ? (
                ...
                <div className="bg-black w-[1px] sm:hidden"></div>
            ...
            <div
                className={`flex flex-col items-baseline gap-4 md:left-[-200px] absolute top-20 left-0 w-54 h-[90vh] bg-gray-200 mt-[-20px] p-6 z-20 transition-all duration-300 ease-in-out ${isMenu ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-full pointer-events-none"}`}>
